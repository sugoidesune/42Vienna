...
C1 SEND PASS 1234
C1 SEND NICK Ali117
C1 SEND USER ali117 0 * :Ali117
C1 EXPECT 001 Ali117 :*

# C2 registers as Bob
C2 SEND PASS 1234
C2 SEND NICK Bob117
C2 SEND USER bob117 0 * :Bob117
C2 EXPECT 001 Bob117 :*

# Both join #syncchan
C1 SEND JOIN #syncchan
C1 EXPECT 353 Ali117 = #syncchan :*
C1 EXPECT 366 Ali117 #syncchan :End of /NAMES list

C2 SEND JOIN #syncchan
C1 WAIT_RECV :Bob117!* JOIN #syncchan
